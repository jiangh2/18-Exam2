...
def problem2a(triangle):
    ...
    Type hints:
      ...
      :rtype: Triangle
    """
    double_a = 2 * triangle.a
    double_b = 2 * triangle.b
    double_c = 2 * triangle.c
    double_triangle = Triangle(double_a, double_b, double_c)
...
def problem2b(triangles):
    ...
    for k in range(len(triangles)):
        total_area = total_area + triangles[k].get_area()
    return total_area
    # -------------------------------------------------------------------------
